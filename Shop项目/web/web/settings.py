...
SECRET_KEY = 'fz%p70gh&=0cqxjb4)d%jqbv)c_3i7nj%8&sr!*#0b3e@dc7(*'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'shop',#选择数据库的名,请确认你的mysql中有这个库
        'USER': 'root',
        'PASSWORD': '123456',
        'HOST': 'localhost',
        'PORT': '3306',
...
# 回调通知地址
# 如果只可以内网访问开发服务器
ALIPAY_NOTIFY_URL = "http://259x26d451.qicp.vip/order/pay_result/" 
# 如果生产环境或外网可以访问开发服务器
# ALIPAY_NOTIFY_URL = "http://1.203.45.678:8000/order/pay_result/" 

# 支付后的跳转地址
ALIPAY_RETURN_URL = 'http://259x26d451.qicp.vip/order/pay_success/'
